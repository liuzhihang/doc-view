...
1. **If no change name provided, prompt for selection**
   ...
   Run `openspec list --json`, show the changes that contain delta specs, and ask the user to select one. Use structured user input when the runtime provides it; otherwise ask directly.
