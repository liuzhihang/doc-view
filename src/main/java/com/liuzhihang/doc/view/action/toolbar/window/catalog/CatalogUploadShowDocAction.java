 ...
 */
public class CatalogUploadShowDocAction extends AbstractUploadAction {
    ...
    public void actionPerformed(@NotNull AnActionEvent e) {
        ...
        if (simpleTree.getLastSelectedPathComponent() instanceof DocViewWindowTreeNode) {
            ...
            // 上传到 yapi
            DocViewUploadService uploadService = ServiceManager.getService(ShowDocServiceImpl.class);
